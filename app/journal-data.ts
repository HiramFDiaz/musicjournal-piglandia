...
export const THEMES: Record<ThemeKey, ThemeDef> = {
  cuban: {
    ...
    quotes: [
      { text: "Y donde quiera que estés, ahí están la palma y la luna.", author: "José Martí (paráfrasis)" },
      ...
      { text: "Cuban music does not sit still; it walks, jokes, remembers, and dances.", author: "" },
      { text: "Cuba put Europe, Africa, sugar, ports, drums, guitars, saints, sailors, and street vendors into one clave.", author: "" },
      { text: "Son cubano is elegant because it never tries too hard; it smiles, then breaks your heart.", author: "" },
      { text: "In Cuban music, rhythm is not decoration. It is the architecture.", author: "" },
      { text: "The clave is small enough to tap with two sticks and strong enough to hold a whole country together.", author: "" },
      { text: "La música cubana no explica la vida; la pone a bailar.", author: "" },
      { text: "En Cuba, el ritmo no acompaña: manda.", author: "" },
      { text: "La clave es pequeña, pero sostiene un mundo.", author: "" },
      { text: "El son no grita; camina con elegancia.", author: "" },
      { text: "Cuba convirtió la nostalgia en ritmo.", author: "" },
      { text: "Donde suena un tres, aparece un camino.", author: "" },
      { text: "La música cubana sabe reír sin dejar de recordar.", author: "" },
      { text: "El tambor trae África; la guitarra trae España; la clave hace Cuba.", author: "" },
      { text: "El son entra suave y se queda para siempre.", author: "" },
      { text: "Cuba no inventó la alegría, pero le dio compás.", author: "" },
      { text: "Una linda sevillana\nle dijo a su maridito\nme vuelvo loca chiquito\npor la música cubana.", author: "" },
      ...
      { text: "La rumba es como la vida — empieza despacio y termina sin avisar.", author: "Cuban dicho" },
      { text: "El bolero es la canción del alma.", author: "Cuban dicho" },
